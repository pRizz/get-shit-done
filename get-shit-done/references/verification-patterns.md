...
1. **Substantive** - Content is real implementation, not placeholder
1. **Wired** - Connected to the rest of the system
1. **Functional** - Actually works when invoked
...
**@~/.claude/get-shit-done/references/checkpoints.md** → `<automation-reference>` section
