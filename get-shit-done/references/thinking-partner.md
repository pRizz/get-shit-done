...
1. **Opt-in** — must be explicitly enabled, never activates by default
1. **Skippable** — always offer "No, I've decided" to bypass
1. **Brief** — 3-5 bullets max, not a full research report
1. **Aligned** — recommendations reference PROJECT.md goals when available
