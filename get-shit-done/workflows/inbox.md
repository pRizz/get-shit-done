...
1. If no linked issue: **GATE VIOLATION** — PR has no issue
1. If linked issue exists, check its labels:
...
1. If label is missing: **GATE VIOLATION** — PR opened before approval
