...
1. **Git log** — commits made during this session (last 24h or since last report)
1. **Plan/Summary files** — plans executed, summaries written
1. **ROADMAP.md** — milestone context and phase goals
