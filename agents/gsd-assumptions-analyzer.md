...
- `<phase-goal>` -- phase description from ROADMAP.md
- `<prior-decisions>` -- summary of locked decisions from earlier phases
- `<codebase-hints>` -- scout results (relevant files, components, patterns found)
- `<calibration-tier>` -- one of: `full_maturity`, `standard`, `minimal_decisive`
  </input>
