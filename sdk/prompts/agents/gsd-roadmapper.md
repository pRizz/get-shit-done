...
1. Identify dependencies between groups
1. Create phases that complete coherent capabilities
1. Check granularity setting for compression guidance
...
1. Derive 2-5 observable truths (user perspective)
...
1. **Write STATE.md** using output format

1. **Update REQUIREMENTS.md traceability section**
