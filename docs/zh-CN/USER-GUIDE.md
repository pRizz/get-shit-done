...
- [工作流图解](#%E5%B7%A5%E4%BD%9C%E6%B5%81%E5%9B%BE%E8%A7%A3)
...
- [恢复快速参考](#%E6%81%A2%E5%A4%8D%E5%BF%AB%E9%80%9F%E5%8F%82%E8%80%83)
...
**启用：** 在需要验证架构和第 8 个 plan-check 维度的阶段中，在 `/gsd-settings` 里设置 `workflow.nyquist_validation: true`。
...
| `workflow.nyquist_validation` | `true`, `false` | `false` | plan-phase 期间的验证架构研究；第 8 个计划检查维度 |
