...
| `model_profile` | enum | `quality`, `balanced`, `budget`, `inherit` | `balanced`    | 各エージェントのモデルティア（[モデルプロファイル](#%E3%83%A2%E3%83%87%E3%83%AB%E3%83%97%E3%83%AD%E3%83%95%E3%82%A1%E3%82%A4%E3%83%AB)を参照） |
...
1. `.planning/` を `.gitignore` に追加
1. 既にトラッキング済みの場合: `git rm -r --cached .planning/ && git commit -m "chore: stop tracking planning docs"`
