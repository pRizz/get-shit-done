...
- [ワークフロー図](#%E3%83%AF%E3%83%BC%E3%82%AF%E3%83%95%E3%83%AD%E3%83%BC%E5%9B%B3)
- [UI デザインコントラクト](#ui-%E3%83%87%E3%82%B6%E3%82%A4%E3%83%B3%E3%82%B3%E3%83%B3%E3%83%88%E3%83%A9%E3%82%AF%E3%83%88)
- [バックログとスレッド](#%E3%83%90%E3%83%83%E3%82%AF%E3%83%AD%E3%82%B0%E3%81%A8%E3%82%B9%E3%83%AC%E3%83%83%E3%83%89)
- [ワークストリーム](#%E3%83%AF%E3%83%BC%E3%82%AF%E3%82%B9%E3%83%88%E3%83%AA%E3%83%BC%E3%83%A0)
- [セキュリティ](#%E3%82%BB%E3%82%AD%E3%83%A5%E3%83%AA%E3%83%86%E3%82%A3)
- [コマンドリファレンス](#%E3%82%B3%E3%83%9E%E3%83%B3%E3%83%89%E3%83%AA%E3%83%95%E3%82%A1%E3%83%AC%E3%83%B3%E3%82%B9)
- [設定リファレンス](#%E8%A8%AD%E5%AE%9A%E3%83%AA%E3%83%95%E3%82%A1%E3%83%AC%E3%83%B3%E3%82%B9)
...
- [リカバリークイックリファレンス](#%E3%83%AA%E3%82%AB%E3%83%90%E3%83%AA%E3%83%BC%E3%82%AF%E3%82%A4%E3%83%83%E3%82%AF%E3%83%AA%E3%83%95%E3%82%A1%E3%83%AC%E3%83%B3%E3%82%B9)
...
**有効化：** バリデーションアーキテクチャと 8 番目の plan-check 次元が必要なフェーズでは、`/gsd-settings` で `workflow.nyquist_validation: true` を設定してください。
...
1. 前提の構造化リストを生成（技術選定、パターン、ファイル配置）
1. 前提を提示し、確認・修正・補足を求める
1. 確認された前提から CONTEXT.md を作成
...
1. デザインシステムの状態を検出（shadcn components.json、Tailwind 設定、既存トークン）
1. shadcn 初期化ゲート — React/Next.js/Vite プロジェクトで未設定の場合、初期化を提案
1. 未回答のデザインコントラクト質問のみを確認（スペーシング、タイポグラフィ、カラー、コピーライティング、レジストリの安全性）
1. `{phase}-UI-SPEC.md` をフェーズディレクトリに書き出す
1. 6つの次元で検証（コピーライティング、ビジュアル、カラー、タイポグラフィ、スペーシング、レジストリの安全性）
1. BLOCKED の場合はリビジョンループ（最大2回）
...
1. ビジュアル — フォーカルポイント、ビジュアルヒエラルキー、アイコンのアクセシビリティ
1. カラー — アクセントカラーの使用規律、60/30/10 準拠
1. タイポグラフィ — フォントサイズ/ウェイト制約の遵守
1. スペーシング — グリッド整列、トークンの一貫性
1. エクスペリエンスデザイン — ローディング/エラー/空状態のカバレッジ
...
1. プリセット文字列をコピー
1. `npx shadcn init --preset {paste}` を実行
1. プリセットはデザインシステム全体をエンコード — カラー、ボーダーラディウス、フォント
...
| `workflow.nyquist_validation`        | `true`, `false`           | `false`    | plan-phase 時のバリデーションアーキテクチャリサーチ、8番目の plan-check 次元                      |
...
- **inherit** -- すべてのエージェントが現在のセッションモデルを使用。モデルを動的に切り替える場合（例：OpenCode または Kilo の `/model`）や、Claude Code を非 Anthropic プロバイダー（OpenRouter、ローカルモデル）で使用する場合に最適で、予期しない API コストを回避できます。非 Claude ランタイム（Codex、OpenCode、Gemini CLI、Kilo）では、インストーラーが自動的に `resolve_model_ids: "omit"` を設定します -- [非 Claude ランタイムの使用](#%E9%9D%9E-claude-%E3%83%A9%E3%83%B3%E3%82%BF%E3%82%A4%E3%83%A0%E3%81%AE%E4%BD%BF%E7%94%A8codexopencodegemini-clikilo)を参照。
