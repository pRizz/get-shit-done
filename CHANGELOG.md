...
- Agent workflows include `<available-agent-types>` for named agent spawning
...
- Researcher receives phase-specific requirement IDs and must output a `<phase-requirements>` mapping table
